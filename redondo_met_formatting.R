...
# read in
list <-list.files("/Users/jacktarricone/ch1_jemez/climate_station_data/redondo/raw_data",full.names = TRUE)
list
...
format_csv <-function(file_path){
    ...
    # save
    setwd("/Users/jacktarricone/ch1_jemez/climate_station_data/redondo/formatted/")
...
redondo_met_data <-list.files(path="/Users/jacktarricone/ch1_jemez/climate_station_data/redondo/formatted/", full.names = TRUE) %>% 
  lapply(read.csv) %>% 
  bind_rows
...
# save rough csv
write.csv(redondo_met_data, "/Users/jacktarricone/ch1_jemez/climate_station_data/redondo/redondo_met_data_v2.csv", row.names =  FALSE)
